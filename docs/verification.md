...
**Letzter Lauf:** 2026-08-17T10:22:20Z
...
- Native Scripting 0.5.1 (`Gen1Recomp Native 051`): 33 Einträge, 8.345.651 Bytes, SHA-256 `6ab5468a…`; ergänzt Metadaten-Refresh, exakten `--slot`-Start, geschlossenes SHA-256-Save-Backup über die Dateien-App, doppelt validierten transaktionalen Restore mit `.bak`-Erhalt und bestätigtes selektives Löschen. Fake-IDBFS führt Schema-21-List/Read/Restore/Delete aus. Beide TypeScript-Ziele, 122/122 Node- und 30 ausgeführte Python-Tests (5 Umgebungsskips), deterministischer Rebuild, ZIP und npm audit 0 bestanden; physische Files-/Slot-/Restore-Prüfung steht aus. Bericht: [`gen1recomp/scripting-native-051-report.json`](gen1recomp/scripting-native-051-report.json);
...
- physische Scripting-/iOS-Ausführung: Preview 0.1.4 und Native-0.2.0-Settings→Runtime-Startup **bestanden** auf iPhone/iOS 18.7; Native 0.4.0–0.4.9 belegten auf Scripting 3.2.0/iOS 26.6 kanonischen Yellow-Import, Extraktion, Spiel, Touch, Retina und Pacing. Native 0.5.0/0.5.1 sowie Datei-/GitHub-Mod-, Komponenten- und Save-Backup-Pfade bleiben offen.
...
- Native-0.5.1-Fünf-Tab-TSX und adaptive Game-/Save-Karten auf iPhone/iPad einschließlich Dark Mode, Dynamic Type und VoiceOver;
