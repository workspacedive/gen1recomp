...
- Native Scripting 0.4.0 (`Gen1Recomp Native 040`): 32 Einträge, 8.320.470 Bytes, SHA-256 `2d6ae25c…`; exakte ROM-Größe/SHA-1, strikte private Game-Registry/Recovery, Pending-Source, In-Memory-Handoff, upstream Import-/Direktstartgrenze, v10-Cacheprüfung, native Karten, Save-Metadaten und selektive Cachelöschung sind implementiert. Beide TypeScript-Ziele, 104/104 Node-Tests und 30/30 ausgeführte Python-Tests bestanden (3 umgebungsbedingt übersprungen), npm audit meldete 0 Schwachstellen. Die exakte Artefakt-Runtime erreichte in Chromium 149.0.7827.0 Frame 104 ohne Page-/Request-/HTTP-Fehler; ein 1-MiB-Nullfixture belegte ausschließlich Transfer/Entfernung ohne Cachemarker, und die IDBFS-Wartung löschte nur Yellow-Cacheeinträge bei erhaltenem Yellow-Save/Red-Cache. Keine ROM wurde für diese Tests verwendet. Reale Scripting-/ROM-Extraktion bleibt offen. Bericht: [`gen1recomp/scripting-native-040-report.json`](gen1recomp/scripting-native-040-report.json);
