...
- Native Scripting 0.4.3 (`Gen1Recomp Native 043`): 32 Einträge, 8.322.151 Bytes, SHA-256 `24289a69…`; der love.js-Adapter ignoriert nur `setLooping` auf Queue-Sources und delegiert andere Source-Typen unverändert. Ein echter gepinnter love.js-Probe belegte Queue: kein Throw/weiter non-looping und Static: looping aktiv. Die exakte Artefakt-Runtime erreichte Chromium-Ready-Event-Frame 15 fehlerfrei; der bekannte generische Pre-Window-Alert wird nach Logging ohne Modal unterdrückt. Physische Game-Window-/Audio-Regression steht aus. Bericht: [`gen1recomp/scripting-native-043-report.json`](gen1recomp/scripting-native-043-report.json);
