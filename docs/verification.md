...
- Native Scripting 0.4.2 (`Gen1Recomp Native 042`): 32 Einträge, 8.321.442 Bytes, SHA-256 `b111e878…`; behält die BitOp-Korrektur und leitet begrenzte WebView-Consolelogs/-warnungen/-fehler, Error-Stacks und Alerts an den nativen Message-Handler weiter. Die exakte ROM-freie Artefakt-Runtime erreichte in Chromium 149 Ready-Event-Frame 18 ohne Page-/Request-/HTTP-Fehler; Warning-, Error- und Alert-Fixtures erreichten nachweislich den nativen Handler. Physisch muss nun der bislang verborgene Fehlertext erhoben werden. Bericht: [`gen1recomp/scripting-native-042-report.json`](gen1recomp/scripting-native-042-report.json);
