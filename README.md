...
- [`docs/gen1recomp/scripting-native-040-report.json`](docs/gen1recomp/scripting-native-040-report.json) / [`scripting-native-041-report.json`](docs/gen1recomp/scripting-native-041-report.json) / [`scripting-native-042-report.json`](docs/gen1recomp/scripting-native-042-report.json) / [`scripting-native-043-report.json`](docs/gen1recomp/scripting-native-043-report.json) / [`scripting-native-044-report.json`](docs/gen1recomp/scripting-native-044-report.json) / [`scripting-native-044-device-plan.md`](docs/gen1recomp/scripting-native-044-device-plan.md) — physischer Yellow-Importbefund, BitOp-Korrekturbericht und verbleibender Geräteplan
...
- `scripting/Gen1RecompApp/`: nativer 0.4.6-Produktshell mit persistentem verifiziertem Spieleimport, privater Registry/Recovery, dynamischen Karten, ROM-zu-Extractor-Handoff, korrigierter love.js-Kompatibilität, verzögertem sichtbarem Vollflächen-Viewport, begrenzten Audio-Synthese-Slices, Performance-Telemetrie, direktem Game-Start, Save-Metadaten und getrennten Komponenten-/Modpfaden;
...
Direkt importierbare, ROM-freie Pakete liegen unter [`artifacts/`](artifacts/). Preview 0.1.4 und Native 0.2.0 belegen den physischen Runtimepfad; Native 0.4.4 erreichte physisch mit sichtbaren Upstream-Controls Oak's Lab. Native 0.4.5 belegte den vor Präsentation gemeldeten `1×1`-Viewport und schwere periodische Frame-Gaps. Native 0.4.6 ist der aktuelle sichtbare Vollflächen-/Audio-Slice-Korrekturkandidat.
