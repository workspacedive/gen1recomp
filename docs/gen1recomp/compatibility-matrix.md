...
| Scripting host | 0.4.5-native | 1.0.0 | persistent verified game library, direct game session, cache maintenance, adaptive game surface, timing telemetry, component/mod management; Native 0.4.4 physically reached ordinary touch play into Oak's Lab; 0.4.5 scaling/performance evidence and 0.3.0 file/GitHub paths pending |
| iOS/Scripting platform adapter | 0.4.5-spike | 1.0.0 | physical local-file WebView path passed; current DocumentPicker/Crypto.sha1/Data/WebView evaluate contracts implemented; canonical import/play proven; App Group relaunch/cache durability, adaptive geometry, timing and file/GitHub behavior pending device proof |
...
| Platform UI | 0.4.5-native | 1.0.0 | five-tab navigation, dynamic native game cards/import states/save counts/cache deletion, adaptive game viewport, manual components and inactive mods implemented; broad-device validation pending |
...
| Scripting WebView | love.js PUC Lua 5.1 + BitOp shim | pinned love.js 11.5 | Gen1Recomp 0.1.96 | target 1/2 | **physical canonical Yellow extraction/title/audio and Native 0.4.4 ordinary upstream-touch play into Oak's Lab passed; Native 0.4.5 aspect-matched viewport/timing candidate; exact multitouch, saves, scaling, performance and fidelity parity unverified** |
...
3. Native 0.4.0–0.4.4 physically proved DocumentPicker, canonical Yellow SHA-1, registry/retry, extraction, title/audio, visible controls and ordinary touch play; Native 0.4.5 scaling/timing, cache-ready completion, App Group relaunch and IDBFS durability remain unverified, as do Native 0.3.0 component/mod/GitHub paths.
