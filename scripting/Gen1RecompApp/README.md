...
- Native 0.4.0 proved DocumentPicker, canonical Yellow identity, pending registration/retry, ROM transfer and upstream extractor entry on Scripting 3.2.0/iOS 26.6; Native 0.4.4 still requires physical touch controls and cache-ready confirmation, App Group relaunch durability, IDBFS persistence/deletion, direct game boot, saves, lifecycle/input/audio, iPad adaptation, and component/mod evidence.
