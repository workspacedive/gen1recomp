...
| Lua runtime adapter | unresolved | 1.0.0 | interface only; backend not selected |
| Renderer port | 0.1.0 | 1.0.0 | strict interface and viewport helper; no backend |
| LÖVE host compatibility | unresolved | 1.0.0 | Web spike pending |
| LÖVE distribution | candidate 11.5 web | 11.5.0 | third-party candidate, not validated |
| Kernel façade | 0.1.0 | 1.0.0 | façade/characterization work pending |
| Gen1Recomp core payload | 0.1.96 | upstream internal contract | pinned source/payload available |
...
| Scripting WebView | love.js PUC Lua 5.1 candidate | love.js 11.5 candidate | Gen1Recomp 0.1.96 | target 1/2 | **unverified spike** |
