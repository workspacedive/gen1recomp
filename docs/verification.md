...
- Native Scripting 0.4.9 (`Gen1Recomp Native 049`): 32 Einträge, 8.335.740 Bytes, SHA-256 `7127e47a…`; ersetzt permanenten nativen Navigationstitel durch 3,2-s-Webfade/Top-Reveal/native Dismiss. Alle fünf Toolbarwerte sind direkte native Buttons statt Custom-Wrapper, passend zum offiziellen Descriptorbeispiel und gezielt gegen `t.__type__`. 112 Node- und 32 ausgeführte Python-Tests, direkter Toolbar-/Chrome-Vertrag, deterministischer Rebuild und npm audit 0 bestanden; physische Regression steht aus. Bericht: [`gen1recomp/scripting-native-049-report.json`](gen1recomp/scripting-native-049-report.json);
