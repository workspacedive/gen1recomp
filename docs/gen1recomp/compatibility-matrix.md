...
|---|---|---|---|
| Gen1Recomp integrated baseline | `0.1.96` | packaged `.love` | pinned GitHub release/source plus local adapters |
| Gen1Recomp latest observed release | `0.1.99` | separate candidate component | GitHub release/API digest observed 2026-08-17; not silently integrated |
...
| Scripting host | 0.5.3-native | 1.0.0 | truthful Home library state and toolbar-isolated root dismiss over physically rendered modern tabs; component-builder regression pending |
| iOS/Scripting platform adapter | 0.5.3-spike | 1.0.0 | canonical play/Retina/readiness-bound title/modern tabs physically proven; toolbar-free native shell and Files backup implemented; phone/save round-trip pending |
...
| Platform UI | 0.5.3-native | 1.0.0 | explicit loading/content/error Home summary, zero toolbar descriptors, centralized dismiss, modern tabs and complete existing management surfaces; broad validation pending |
...
| Scripting WebView | love.js PUC Lua 5.1 + BitOp/audio/frame/touch adapters | pinned love.js 11.5 | Gen1Recomp 0.1.96 | target 1/2 | **Retina `1320×2868`/Scale 8, game load and readiness-bound title physically passed; Native 0.5.3 leaves all game bytes unchanged while isolating native toolbar metadata; exact close/save/phone evidence pending** |
...
3. Native 0.4.0–0.4.8 physically proved canonical play, Retina geometry and near-60 Hz motion; Native 0.4.9 title/toolbar regression, phone-call recovery, warm cache, cache-ready UI and broader persistence remain unverified, as do component/mod/GitHub paths.
