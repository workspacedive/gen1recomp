...
- Native Scripting 0.4.7 (`Gen1Recomp Native 047`): 32 Einträge, 8.330.715 Bytes, SHA-256 `68077463…`; verteilt Musik als 512-Sample-Slices × maximal zwei je Update, persistiert Effekte privat als PCM-WAV mit exakt geprüfter kanonischer Signatur und misst Update/Draw separat. Lua-5.4-Syntax, Fake-Runtime Store→Hit, 109 Node-Tests, 31 ausgeführte Python-Tests, deterministischer Rebuild und npm audit 0 bestanden; die physische Warm-Cache-Prüfung steht aus. Bericht: [`gen1recomp/scripting-native-047-report.json`](gen1recomp/scripting-native-047-report.json);
