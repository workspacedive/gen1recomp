...
- Native Scripting 0.4.8 (`Gen1Recomp Native 048`): 32 Einträge, 8.333.969 Bytes, SHA-256 `de7fbce8…`; plant auf dem Primärgerät `1320×2868` native Retina-Pixel/Fit-Scale 8, ersetzt nur Control-Zeichnung durch Vektoren und paart Host-Unterbrechungen mit Flush/Pause/Resume/750-ms-Watchdog. 112 Node- und 32 ausgeführte Python-Tests, Lua-Syntax/Fake-Vektordraw, Lifecycle-Unitfälle, deterministischer Rebuild und npm audit 0 bestanden; physische Qualitäts-, Füllraten- und Telefon-Recovery-Prüfung steht aus. Bericht: [`gen1recomp/scripting-native-048-report.json`](gen1recomp/scripting-native-048-report.json);
